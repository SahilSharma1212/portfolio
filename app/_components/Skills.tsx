...
export default function Skills() {
    ...
    return (
        <div id="skills" className="min-h-screen w-screen bg-linear-to-bl from-[#070707] to-[#030303] via-[#090909] text-white overflow-hidden p-4 sm:p-6 md:p-12 lg:p-20 relative flex flex-col items-center justify-center">
                            ...
                            <div className="flex flex-wrap gap-3">
                                {cat.data.map((skill) => (
                                    <div
                                        key={skill.name}
                                        ref={(el) => {
                                            if (el) skillRefs.current.push(el);
                                        }}
                                        style={borderStyles}
                                        className="flex items-center gap-2 px-3 sm:px-4 py-2 transition-all duration-300 relative overflow-hidden group/skill"
                                    >
                                        <AnimatedBorder />
                                        ...
                                        <span className="relative z-10 text-xs sm:text-sm font-mono text-neutral-300 group-hover/skill:text-white transition-colors duration-300 whitespace-nowrap">
                                            {skill.name}
                                        </span>
                                    </div>
                                ))}
